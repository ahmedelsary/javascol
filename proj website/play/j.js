...
tt_2=document.getElementById("+t-2");
...
tt_2.style.position='absolute';
tt_2.style.top='50px';
tt_2.style.left='450px';
tt_2.style.display='block';
...
sk3=document.getElementById("skull3");
sk4=document.getElementById("skull4");
...
sk3.style.position='absolute';
sk3.style.top='375px';
sk3.style.left='200px';
sk3.style.display="block";

sk4.style.position='absolute';
sk4.style.top='375px';
sk4.style.left='450px';
...
sk3=document.getElementById("skull3");
sk4=document.getElementById("skull4");
sk5=document.getElementById("skull5");

tt_1=document.getElementById("+t-1");
tt_2=document.getElementById("+t-2");
t_1=document.getElementById("-t-1");
t_2=document.getElementById("-t-2");
...
sk5.style.position='absolute';
sk5.style.top='100px';
sk5.style.left='450px';
sk5.style.display="block";
...
turtle2.style.position='absolute';
turtle2.style.top='250px';
turtle2.style.left='500px';
turtle2.style.display='block';

break;

case 4:alert("You Win!"); cont.innerHTML=" <center style=' font-weight:bold; font-size:30px; margin-top:200px;'>WOW you finished the game!</center>";
...
function boom(){
 ...
 { 
    ...
    && 
    parseInt(el.style.top)>=parseInt(BlocksArray[j].style.top)-47 
    && 
 ...
 for (var k=0;k<RocketArray.length;k++){
    ...
    ( parseInt(el.style.left)==parseInt(RocketArray[k].style.left)+parseInt(el.style.height)-10
     ...
     ||
      ...
      RocketArray[k].style.display="none"; RocketArray.splice(k,1); speed-=4; 
      switch(deg){
                case 1:
                clearInterval(i);
 ...
 for (var k=0;k<TurtleArray.length;k++){
    ...
    ( parseInt(el.style.left)==parseInt(TurtleArray[k].style.left)+parseInt(el.style.height)-10
     ...
     ||
      ...
      TurtleArray[k].style.display="none"; TurtleArray.splice(k,1); speed+=4;  
            switch(deg){
                case 1:
                clearInterval(i);
        i=setInterval(moveup,speed); break;
     ...
     ||
      ...
      
      {
        switch(TimeArray[k].id.charAt(0)){
            case '+':TimeArray[k].style.display="none"; TimeArray.splice(k,1); sec+=10; tim.innerHTML="Time:"+sec;   break;    
            case '-':TimeArray[k].style.display="none"; TimeArray.splice(k,1); sec-=10; if(sec>0){tim.innerHTML="Time:"+sec;} else{tim.innerHTML="Time:0";}  break;         
        } 
	}   
} 
